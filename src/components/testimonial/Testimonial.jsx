                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">First and foremost, the selection of mobile phones available at 7mobiles is outstanding. From the latest flagship models to more budget-friendly options, there's something for every taste and budget. I appreciated the fact that they carry a diverse range of brands, allowing customers to compare and choose the best fit for needs.</p>
                                <span className="inline-block h-1 w-10 rounded bg-green-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">SuryaKumar</h2>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">I recently visited 7mobiles to purchase a new smartphone, and I am beyond impressed with my experience. From the moment I walked in, I was greeted by friendly and knowledgeable staff who guided me through their extensive range of mobile devices.</p>
                                <span className="inline-block h-1 w-10 rounded bg-green-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">S kavya</h2>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">I recently had the pleasure of shopping at 7mobiles, and I must say, it was a fantastic experience from start to finish. From their wide selection of mobile devices to their impeccable customer service, everything about my visit exceeded my expectations.</p>
                                <span className="inline-block h-1 w-10 rounded bg-green-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Yuvan</h2>
                                <p className="text-gray-500">IT Employee</p>
                            </div>
                        </div>
                    </div>
                </div>
